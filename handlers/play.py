...
async def play(client: Client, message_: Message):
    ...
    res = await message_.reply_text("✯𝗖𝗵𝗼𝗰𝗼𝗹𝗮𝘁𝘆𝗤𝘂𝗲𝗲𝗻𝗕𝗼𝘁✯=🔄 Processing...")
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        chat_id=message_.chat.id,
        photo="https://telegra.ph/file/200b2cebc65cfbe720dd0.png",
        caption=f"Playing Your song Via  [✯✯](https://t.me/F1F1Fl).",
         ) 
...
async def deezer(client: Client, message_: Message):
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        position = sira.add(message_.chat.id, file_path)
        await res.edit_text(f"✯𝗖𝗵𝗼𝗰𝗼𝗹𝗮𝘁𝘆𝗤𝘂𝗲𝗲𝗻𝗕𝗼𝘁✯=#️⃣ Queued at position {position}.")
    else:
        await res.edit_text("✯𝗖𝗵𝗼𝗰𝗼𝗹𝗮𝘁𝘆𝗤𝘂𝗲𝗲𝗻𝗕𝗼𝘁✯=▶️ Playing.....")
        tgcalls.pytgcalls.join_group_call(message_.chat.id, file_path)
    await res.delete()
    m = await client.send_photo(
        chat_id=message_.chat.id,
        photo="final.png",
        caption=f"Playing [{title}]({url}) Via [المطور](https://t.me/F1F1Fl)."
    ) 
    os.remove("final.png")
# -----------------------------------------------------Jiosaavn-----------------------------------------------------------------
@Client.on_message(
...
async def jiosaavn(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing {sname} Via [المطور](https://t.me/F1F1Fl)",
        photo="final.png",
    )
    os.remove("final.png")
...
async def ytp(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing `{query}` Via [المطور](https://t.me/F1F1Fl)",
        photo="final.png",
