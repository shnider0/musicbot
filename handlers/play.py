...
import sira
from config import DURATION_LIMIT,SUDO_USERS 
...
async def play(client: Client, message_: Message):
    ...
    res = await message_.reply_text("✯BOTMUSI✯=🔄 Processing...")
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        chat_id=message_.chat.id,
        photo="https://telegra.ph/file/02c85a7cb1a8774332af4.jpg",
        caption=f"Playing Your song Via  [✯BOTMUSIC✯](https://t.me/BOTS_MUSIC_IQ).",
         ) 
...
async def deezer(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        photo="final.png",
        caption=f"Playing [{title}]({url}) Via [DEV](https://t.me/BOTS_MUSIC_IQ)."
    ) 
    os.remove("final.png")
# -----------------------------------------------------Jiosaavn-----------------------------------------------------------------
@Client.on_message(
...
async def jiosaavn(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing {sname} Via [DEV](https://t.me/BOTS_MUSIC_IQ)",
        photo="final.png",
    )
    os.remove("final.png")
...
async def ytp(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing `{query}` Via [YouTube](https://t.me/BOTS_MUSIC_IQ)",
        photo="final.png",
